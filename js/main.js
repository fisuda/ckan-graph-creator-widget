(function () {
  ...
  var createGraph = function() {
    ...
    for (var i = 0; i < dataset['structure'].length && group_column_type == null; i++) {
    ...
    for (var i = 0; i < dataset['data'].length && !group_column_float; i++) {
  ...
  var showSeriesInfo = function(dataset_json) {
